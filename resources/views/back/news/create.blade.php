                ...
                <form method="post" action="{{ route('panel.news.store') }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group row d-flex justify-content-center">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFile">Rekomendasi dimensi gambar 1904 x 752</label>
                                </div>
                                <label>pastikan ukuran foto tidak lebih dari 2mb (dimension : 1904 x 752)</label>
                                <img id="image_preview" src="#" alt="" class="img-thumbnail">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="news_content" id="news_content" rows="10" cols="80">{{ old('news_content') }}</textarea>
                                <!-- <textarea id="news_content" name="news_content" rows="10" class="textarea summernote" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>-->
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="news_tags" class="col-sm-2 col-form-label">Tags</label>
                            <div class="col-sm-10">
                                <div data-tags-input-name="tag" id="tagBox">shoesmart</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" name="contributor_id"  style="width: 100%;">
                                    ...
                                    <option value="{{ $item->id }}">{{ $item->name_contributor }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
